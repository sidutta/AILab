...
circuitgrounded(xor,A):-isgrounded(gn1,A).
circuitgrounded(xor,A):-isgrounded(gn2,A).
circuitgrounded(xor,A):-isgrounded(ga1,A).
circuitgrounded(xor,A):-isgrounded(ga2,A).
circuitgrounded(xor,A):-isgrounded(go1,A).
